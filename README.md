...
![Главная страница](./assets/home-page-screenshot-second.jpg)
...
- Адаптивное меню-бургер
  ![Адаптивное меню-бургер](./assets/burger-menu-screenshot.jpg)
- Вертикальная лента контента
- Оптимизированные карточки фильмов
  ![Оптимизированные карточки фильмов](./assets/card-screenshot.jpg)
